...
<head>
    ...
    <!-- my js -->
    <script src="/resources/js/audius.js"></script>

    <!-- my css -->
    <link type="text/css" rel="stylesheet" href="/resources/css/audius.css"/>
</head>

<body>
    <div class="quickmenu">
        <ul>
            <li><a href="#homeup" id="homeup">TOP</a></li>
            <li><a href="#homedown" id="homedown">BOTTOM</a></li>
        </ul>
    </div>
<!-- HEADER -->
<header id="header">
...
<br>
<br>
<h1 style="text-align: center; font-variant: small-caps; font-size: 60px;">Tracks 100 Audius</h1>
<br>
<br>
<br>
<br>
