...
<head>
    ...
    <!-- my js -->
    <script src="/resources/js/napster.js"></script>

    <style>
        img:hover {
            transform: scale(1.1, 1.1); /* 가로2배 새로 1.5배 로 커짐 */
            transition: transform .9s; /* 커지는 시간 */
        }
    </style>
...
<br>
<br>
<h1 style="text-align: center; font-variant: small-caps; font-size: 60px;">Artists 20 Napster</h1>
<br>
<br>
<br>
<br>
